...
object BadWordFilterWithoutBadWordDataAndMultipleLinesBenchmark extends Bench.OfflineReport {
  val oldBadWordFilter = new OldBadWordFilter

  // Setup test data
  val data: mutable.WrappedArray[String] = Utils.getDataFromFile("data/not_has_bad_word/200_lines_5000_chars_each.txt")
